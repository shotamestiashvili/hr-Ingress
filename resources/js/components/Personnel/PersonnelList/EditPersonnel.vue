  ...
  data() {
    return {
      ...
      form: {
        ...
        companyid: this.editing.companyid,
        ...
        food: this.editing.food,
        ensuarence: this.editing.ensuarence,
        additional: this.editing.additional,
        bank_account: this.editing.bank_account,
        avatar_url: this.editing.avatar_url,
      },
    };
  },
